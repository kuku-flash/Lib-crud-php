...
$sql="INSERT INTO  tblbooks(BookName,CatId,AuthorId,ISBNNumber,BookPrice,bookImage, publisher) VALUES(:bookname,:category,:author,:isbn,:price,:imgnewname,:publisher)";
...
<div class="col-md-6">  
 ...
 <input class="form-control" type="text" name="publisher" autocomplete="off"   required="required" />
 </div>
</div>
